...
__all__ = ['CloudAccountAzureArgs', 'CloudAccountAzure']
...
class CloudAccountAzureArgs:
    def __init__(__self__, *,
                 ...
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input['CloudAccountAzureTagArgs']]]] = None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input['CloudAccountAzureTagArgs']]] tags: Set of tag keys and values to apply to the cloud account.  
    ...
    @property
    @pulumi.getter
    def tags(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['CloudAccountAzureTagArgs']]]]:
        """
    ...
    @tags.setter
    def tags(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['CloudAccountAzureTagArgs']]]]):
        pulumi.set(self, "tags", value)


@pulumi.input_type
class _CloudAccountAzureState:
    def __init__(__self__, *,
                 application_id: Optional[pulumi.Input[str]] = None,
                 application_key: Optional[pulumi.Input[str]] = None,
                 created_at: Optional[pulumi.Input[str]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 links: Optional[pulumi.Input[Sequence[pulumi.Input['CloudAccountAzureLinkArgs']]]] = None,
                 name: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] description: Human-friendly description.
        :param pulumi.Input[Sequence[pulumi.Input['CloudAccountAzureLinkArgs']]] links: HATEOAS of entity.
        :param pulumi.Input[str] name: Name of Azure cloud account.
    ...
    @property
    @pulumi.getter
    def links(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['CloudAccountAzureLinkArgs']]]]:
        """
        HATEOAS of entity.
        """
    ...
    @links.setter
    def links(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['CloudAccountAzureLinkArgs']]]]):
...
class CloudAccountAzure(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 regions: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 subscription_id: Optional[pulumi.Input[str]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CloudAccountAzureTagArgs']]]]] = None,
                 tenant_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] regions: Set of region names enabled for the cloud account.
        :param pulumi.Input[str] subscription_id: Azure Subscription ID.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CloudAccountAzureTagArgs']]]] tags: Set of tag keys and values to apply to the cloud account.  
               Example:[ { "key" : "vmware", "value": "provider" } ]
        :param pulumi.Input[str] tenant_id: Azure Tenant ID.
        """
        ...
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param CloudAccountAzureArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CloudAccountAzureArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CloudAccountAzureArgs.__new__(CloudAccountAzureArgs)
        ...
        super(CloudAccountAzure, __self__).__init__(
            'vra:index/cloudAccountAzure:CloudAccountAzure',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            created_at: Optional[pulumi.Input[str]] = None,
            description: Optional[pulumi.Input[str]] = None,
            links: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CloudAccountAzureLinkArgs']]]]] = None,
            name: Optional[pulumi.Input[str]] = None,
            org_id: Optional[pulumi.Input[str]] = None,
            owner: Optional[pulumi.Input[str]] = None,
            regions: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            ...
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CloudAccountAzureTagArgs']]]]] = None,
            tenant_id: Optional[pulumi.Input[str]] = None,
            updated_at: Optional[pulumi.Input[str]] = None) -> 'CloudAccountAzure':
        """
        ...
        :param pulumi.Input[str] created_at: Date when entity was created. Date and time format is ISO 8601 and UTC.
        :param pulumi.Input[str] description: Human-friendly description.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CloudAccountAzureLinkArgs']]]] links: HATEOAS of entity.
        :param pulumi.Input[str] name: Name of Azure cloud account.
        :param pulumi.Input[str] org_id: ID of organization that entity belongs to.
        :param pulumi.Input[str] owner: Email of entity owner.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] regions: Set of region names enabled for the cloud account.
        ...
        __props__ = _CloudAccountAzureState.__new__(_CloudAccountAzureState)
        ...
        return CloudAccountAzure(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def links(self) -> pulumi.Output[Sequence['outputs.CloudAccountAzureLink']]:
        """
        HATEOAS of entity.
        """
        return pulumi.get(self, "links")
    ...
    @property
    @pulumi.getter
    def tags(self) -> pulumi.Output[Sequence['outputs.CloudAccountAzureTag']]:
        """
        Set of tag keys and values to apply to the cloud account.  
        Example:[ { "key" : "vmware", "value": "provider" } ]
        """
