...
__all__ = ['CloudAccountVmcArgs', 'CloudAccountVmc']

@pulumi.input_type
class CloudAccountVmcArgs:
    def __init__(__self__, *,
                 ...
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input['CloudAccountVmcTagArgs']]]] = None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input['CloudAccountVmcTagArgs']]] tags: Set of tag keys and values to apply to the cloud account.  
    ...
    @property
    @pulumi.getter
    def tags(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['CloudAccountVmcTagArgs']]]]:
        """
    ...
    @tags.setter
    def tags(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['CloudAccountVmcTagArgs']]]]):
        pulumi.set(self, "tags", value)


@pulumi.input_type
class _CloudAccountVmcState:
    def __init__(__self__, *,
                 accept_self_signed_cert: Optional[pulumi.Input[bool]] = None,
                 ...
                 dc_id: Optional[pulumi.Input[str]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 links: Optional[pulumi.Input[Sequence[pulumi.Input['CloudAccountVmcLinkArgs']]]] = None,
                 name: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] dc_id: Identifier of a data collector VM deployed in the on premise infrastructure. Refer to the data-collector API to create or list data collector.
        :param pulumi.Input[str] description: Human-friendly description.
        :param pulumi.Input[Sequence[pulumi.Input['CloudAccountVmcLinkArgs']]] links: HATEOAS of entity.
        :param pulumi.Input[str] name: Human-friendly name used as an identifier in APIs that support this option.
        :param pulumi.Input[str] nsx_hostname: IP address of the NSX Manager server in the specified SDDC / FQDN.
    ...
    @property
    @pulumi.getter
    def links(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['CloudAccountVmcLinkArgs']]]]:
        """
        HATEOAS of entity.
        """
    ...
    @links.setter
    def links(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['CloudAccountVmcLinkArgs']]]]):
...
class CloudAccountVmc(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 regions: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 sddc_name: Optional[pulumi.Input[str]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CloudAccountVmcTagArgs']]]]] = None,
                 vcenter_hostname: Optional[pulumi.Input[str]] = None,
                 vcenter_password: Optional[pulumi.Input[str]] = None,
                 vcenter_username: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        ...
        **Create VMC cloud account:**
        ...
        this = vra.CloudAccountVmc("this",
            ...
            tags=[vra.CloudAccountVmcTagArgs(
                key="foo",
                value="bar",
            )])
        ```
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] regions: Set of region names enabled for the cloud account.
        :param pulumi.Input[str] sddc_name: Identifier of the on-premise SDDC to be used by the cloud account. Note that NSX-V SDDCs are not supported.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CloudAccountVmcTagArgs']]]] tags: Set of tag keys and values to apply to the cloud account.  
               Example:[ { "key" : "vmware", "value": "provider" } ]
        :param pulumi.Input[str] vcenter_hostname: IP address or FQDN of the vCenter Server in the specified SDDC. The cloud proxy belongs on this vCenter.
        :param pulumi.Input[str] vcenter_password: Password used to authenticate to the cloud Account.
        :param pulumi.Input[str] vcenter_username: vCenter user name for the specified SDDC. The user requires CloudAdmin credentials. The user does not require CloudGlobalAdmin credentials.
    ...
    def __init__(__self__,
        ...
        **Create VMC cloud account:**
        ...
        :param str resource_name: The name of the resource.
        :param CloudAccountVmcArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CloudAccountVmcArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CloudAccountVmcArgs.__new__(CloudAccountVmcArgs)
        ...
        super(CloudAccountVmc, __self__).__init__(
            'vra:index/cloudAccountVmc:CloudAccountVmc',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            dc_id: Optional[pulumi.Input[str]] = None,
            description: Optional[pulumi.Input[str]] = None,
            links: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CloudAccountVmcLinkArgs']]]]] = None,
            name: Optional[pulumi.Input[str]] = None,
            nsx_hostname: Optional[pulumi.Input[str]] = None,
            org_id: Optional[pulumi.Input[str]] = None,
            owner: Optional[pulumi.Input[str]] = None,
            ...
            vcenter_hostname: Optional[pulumi.Input[str]] = None,
            vcenter_password: Optional[pulumi.Input[str]] = None,
            vcenter_username: Optional[pulumi.Input[str]] = None) -> 'CloudAccountVmc':
        """
        ...
        :param pulumi.Input[str] dc_id: Identifier of a data collector VM deployed in the on premise infrastructure. Refer to the data-collector API to create or list data collector.
        :param pulumi.Input[str] description: Human-friendly description.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CloudAccountVmcLinkArgs']]]] links: HATEOAS of entity.
        :param pulumi.Input[str] name: Human-friendly name used as an identifier in APIs that support this option.
        :param pulumi.Input[str] nsx_hostname: IP address of the NSX Manager server in the specified SDDC / FQDN.
        :param pulumi.Input[str] org_id: ID of organization that entity belongs to.
        :param pulumi.Input[str] owner: Email of entity owner.
        ...
        __props__ = _CloudAccountVmcState.__new__(_CloudAccountVmcState)
        ...
        __props__.__dict__["vcenter_password"] = vcenter_password
        __props__.__dict__["vcenter_username"] = vcenter_username
        return CloudAccountVmc(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def links(self) -> pulumi.Output[Sequence['outputs.CloudAccountVmcLink']]:
        """
        HATEOAS of entity.
        """
        return pulumi.get(self, "links")
    ...
    @property
    @pulumi.getter
    def tags(self) -> pulumi.Output[Sequence['outputs.CloudAccountVmcTag']]:
        """
        Set of tag keys and values to apply to the cloud account.  
        Example:[ { "key" : "vmware", "value": "provider" } ]
        """
