...
__all__ = [
    'GetCloudAccountNsxvResult',
    'AwaitableGetCloudAccountNsxvResult',
    'get_cloud_account_nsxv',
    'get_cloud_account_nsxv_output',
]

@pulumi.output_type
class GetCloudAccountNsxvResult:
    """
    ...
    @property
    @pulumi.getter
    def links(self) -> Sequence['outputs.GetCloudAccountNsxvLinkResult']:
        """
    ...
    @property
    @pulumi.getter
    def tags(self) -> Sequence['outputs.GetCloudAccountNsxvTagResult']:
        """
...
class AwaitableGetCloudAccountNsxvResult(GetCloudAccountNsxvResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCloudAccountNsxvResult(
...
def get_cloud_account_nsxv(id: Optional[str] = None,
                           ...
                           tags: Optional[Sequence[pulumi.InputType['GetCloudAccountNsxvTagArgs']]] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCloudAccountNsxvResult:
    """
    ...
    **NSX-V cloud account data source by its name:**
    ...
    :param Sequence[pulumi.InputType['GetCloudAccountNsxvTagArgs']] tags: A set of tag keys and optional values that were set on this resource.
           example:[ { "key" : "vmware", "value": "provider" } ]
    """
    __args__ = dict()
    __args__['id'] = id
    ...
    __ret__ = pulumi.runtime.invoke('vra:index/getCloudAccountNsxv:getCloudAccountNsxv', __args__, opts=opts, typ=GetCloudAccountNsxvResult).value

    return AwaitableGetCloudAccountNsxvResult(
...
@_utilities.lift_output_func(get_cloud_account_nsxv)
def get_cloud_account_nsxv_output(id: Optional[pulumi.Input[Optional[str]]] = None,
                                  name: Optional[pulumi.Input[Optional[str]]] = None,
                                  tags: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetCloudAccountNsxvTagArgs']]]]] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetCloudAccountNsxvResult]:
    """
    Provides a VMware vRA CloudAccountNsxv data source.
