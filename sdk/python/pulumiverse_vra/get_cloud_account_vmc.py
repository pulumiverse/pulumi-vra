...
__all__ = [
    'GetCloudAccountVmcResult',
    'AwaitableGetCloudAccountVmcResult',
    'get_cloud_account_vmc',
    'get_cloud_account_vmc_output',
]

@pulumi.output_type
class GetCloudAccountVmcResult:
    """
    ...
    @property
    @pulumi.getter
    def links(self) -> Sequence['outputs.GetCloudAccountVmcLinkResult']:
        """
    ...
    @property
    @pulumi.getter
    def tags(self) -> Sequence['outputs.GetCloudAccountVmcTagResult']:
        """
...
class AwaitableGetCloudAccountVmcResult(GetCloudAccountVmcResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCloudAccountVmcResult(
...
def get_cloud_account_vmc(id: Optional[str] = None,
                          ...
                          tags: Optional[Sequence[pulumi.InputType['GetCloudAccountVmcTagArgs']]] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCloudAccountVmcResult:
    """
    ...
    **vmc cloud account data source by its name:**
    ...
    :param Sequence[pulumi.InputType['GetCloudAccountVmcTagArgs']] tags: A set of tag keys and optional values that were set on this resource.
           example:[ { "key" : "vmware", "value": "provider" } ]
    """
    __args__ = dict()
    __args__['id'] = id
    ...
    __ret__ = pulumi.runtime.invoke('vra:index/getCloudAccountVmc:getCloudAccountVmc', __args__, opts=opts, typ=GetCloudAccountVmcResult).value

    return AwaitableGetCloudAccountVmcResult(
...
@_utilities.lift_output_func(get_cloud_account_vmc)
def get_cloud_account_vmc_output(id: Optional[pulumi.Input[Optional[str]]] = None,
                                 name: Optional[pulumi.Input[Optional[str]]] = None,
                                 tags: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetCloudAccountVmcTagArgs']]]]] = None,
                                 opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetCloudAccountVmcResult]:
    """
    Provides a VMware vRA CloudAccountVmc data source.
