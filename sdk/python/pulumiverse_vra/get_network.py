...
def get_network(constraints: Optional[Sequence[pulumi.InputType['GetNetworkConstraintArgs']]] = None,
    ...
    page_title: "VMware vRealize Automation: Network"
    description: |-
    ...
    __ret__ = pulumi.runtime.invoke('vra:index/getNetwork:getNetwork', __args__, opts=opts, typ=GetNetworkResult).value
