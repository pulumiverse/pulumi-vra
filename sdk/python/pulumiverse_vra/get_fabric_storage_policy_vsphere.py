...
__all__ = [
    'GetFabricStoragePolicyVsphereResult',
    'AwaitableGetFabricStoragePolicyVsphereResult',
    'get_fabric_storage_policy_vsphere',
    'get_fabric_storage_policy_vsphere_output',
]

@pulumi.output_type
class GetFabricStoragePolicyVsphereResult:
    """
    ...
    @property
    @pulumi.getter
    def links(self) -> Sequence['outputs.GetFabricStoragePolicyVsphereLinkResult']:
        """
...
class AwaitableGetFabricStoragePolicyVsphereResult(GetFabricStoragePolicyVsphereResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetFabricStoragePolicyVsphereResult(
...
def get_fabric_storage_policy_vsphere(filter: Optional[str] = None,
                                      ...
                                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFabricStoragePolicyVsphereResult:
    """
    ## Example Usage
    ### S
    ...
    **Fabric vSphere storage policy by filter query:**
    ...
    __ret__ = pulumi.runtime.invoke('vra:index/getFabricStoragePolicyVsphere:getFabricStoragePolicyVsphere', __args__, opts=opts, typ=GetFabricStoragePolicyVsphereResult).value

    return AwaitableGetFabricStoragePolicyVsphereResult(
...
@_utilities.lift_output_func(get_fabric_storage_policy_vsphere)
def get_fabric_storage_policy_vsphere_output(filter: Optional[pulumi.Input[Optional[str]]] = None,
                                             id: Optional[pulumi.Input[Optional[str]]] = None,
                                             opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetFabricStoragePolicyVsphereResult]:
    """
    ## Example Usage
    ### S
    This is an example of how to lookup fabric vSphere storage policies.
