...
__all__ = ['FabricDatastoreVsphereArgs', 'FabricDatastoreVsphere']

@pulumi.input_type
class FabricDatastoreVsphereArgs:
    def __init__(__self__, *,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input['FabricDatastoreVsphereTagArgs']]]] = None):
        """
        The set of arguments for constructing a FabricDatastoreVsphere resource.
        :param pulumi.Input[Sequence[pulumi.Input['FabricDatastoreVsphereTagArgs']]] tags: A set of tag keys and optional values that were set on this resource:
        """
        if tags is not None:
    ...
    @property
    @pulumi.getter
    def tags(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['FabricDatastoreVsphereTagArgs']]]]:
        """
    ...
    @tags.setter
    def tags(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['FabricDatastoreVsphereTagArgs']]]]):
        pulumi.set(self, "tags", value)


@pulumi.input_type
class _FabricDatastoreVsphereState:
    def __init__(__self__, *,
                 ...
                 links: Optional[pulumi.Input[Sequence[pulumi.Input['FabricDatastoreVsphereLinkArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['FabricDatastoreVsphereLinkArgs']]] links: HATEOAS of the entity
    ...
    @property
    @pulumi.getter
    def links(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['FabricDatastoreVsphereLinkArgs']]]]:
        """
    ...
    @links.setter
    def links(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['FabricDatastoreVsphereLinkArgs']]]]):
...
class FabricDatastoreVsphere(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['FabricDatastoreVsphereTagArgs']]]]] = None,
                 __props__=None):
        """
        ...
        this = vra.FabricDatastoreVsphere("this", tags=[vra.FabricDatastoreVsphereTagArgs(
            key="foo",
            value="bar",
        )])
        ```
        ...
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['FabricDatastoreVsphereTagArgs']]]] tags: A set of tag keys and optional values that were set on this resource:
        """
        ...
    @overload
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param FabricDatastoreVsphereArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(FabricDatastoreVsphereArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = FabricDatastoreVsphereArgs.__new__(FabricDatastoreVsphereArgs)
        ...
        super(FabricDatastoreVsphere, __self__).__init__(
            'vra:index/fabricDatastoreVsphere:FabricDatastoreVsphere',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            external_region_id: Optional[pulumi.Input[str]] = None,
            free_size_gb: Optional[pulumi.Input[str]] = None,
            links: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['FabricDatastoreVsphereLinkArgs']]]]] = None,
            name: Optional[pulumi.Input[str]] = None,
            org_id: Optional[pulumi.Input[str]] = None,
            owner: Optional[pulumi.Input[str]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['FabricDatastoreVsphereTagArgs']]]]] = None,
            type: Optional[pulumi.Input[str]] = None,
            updated_at: Optional[pulumi.Input[str]] = None) -> 'FabricDatastoreVsphere':
        """
        ...
        :param pulumi.Input[str] external_region_id: Id of datacenter in which the datastore is present.
        :param pulumi.Input[str] free_size_gb: Indicates free size available in datastore.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['FabricDatastoreVsphereLinkArgs']]]] links: HATEOAS of the entity
        :param pulumi.Input[str] name: A human-friendly name used as an identifier for the vSphere fabric datastore resource instance.
        :param pulumi.Input[str] org_id: The id of the organization this entity belongs to.
        :param pulumi.Input[str] owner: Email of the user that owns the entity.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['FabricDatastoreVsphereTagArgs']]]] tags: A set of tag keys and optional values that were set on this resource:
        ...
        __props__ = _FabricDatastoreVsphereState.__new__(_FabricDatastoreVsphereState)
        ...
        return FabricDatastoreVsphere(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def links(self) -> pulumi.Output[Sequence['outputs.FabricDatastoreVsphereLink']]:
        """
        HATEOAS of the entity
        """
        return pulumi.get(self, "links")
    ...
    @property
    @pulumi.getter
    def tags(self) -> pulumi.Output[Sequence['outputs.FabricDatastoreVsphereTag']]:
        """
        A set of tag keys and optional values that were set on this resource:
        """
        return pulumi.get(self, "tags")
