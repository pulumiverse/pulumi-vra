...
__all__ = [
    'GetBlueprintVersionResult',
    'AwaitableGetBlueprintVersionResult',
    'get_blueprint_version',
    'get_blueprint_version_output',
]

@pulumi.output_type
class GetBlueprintVersionResult:
    """
...
class AwaitableGetBlueprintVersionResult(GetBlueprintVersionResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetBlueprintVersionResult(
...
def get_blueprint_version(blueprint_id: Optional[str] = None,
                          ...
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetBlueprintVersionResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('vra:index/getBlueprintVersion:getBlueprintVersion', __args__, opts=opts, typ=GetBlueprintVersionResult).value

    return AwaitableGetBlueprintVersionResult(
...
@_utilities.lift_output_func(get_blueprint_version)
def get_blueprint_version_output(blueprint_id: Optional[pulumi.Input[str]] = None,
                                 id: Optional[pulumi.Input[str]] = None,
                                 opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetBlueprintVersionResult]:
    """
    This data source provides information about a cloud template (blueprint) version in vRA.
