...
__all__ = [
    'GetCatalogSourceBlueprintResult',
    'AwaitableGetCatalogSourceBlueprintResult',
    'get_catalog_source_blueprint',
    'get_catalog_source_blueprint_output',
]

@pulumi.output_type
class GetCatalogSourceBlueprintResult:
    """
...
class AwaitableGetCatalogSourceBlueprintResult(GetCatalogSourceBlueprintResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCatalogSourceBlueprintResult(
            config=self.config,
...
def get_catalog_source_blueprint(config: Optional[Mapping[str, str]] = None,
                                 ...
                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCatalogSourceBlueprintResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('vra:index/getCatalogSourceBlueprint:getCatalogSourceBlueprint', __args__, opts=opts, typ=GetCatalogSourceBlueprintResult).value

    return AwaitableGetCatalogSourceBlueprintResult(
...
@_utilities.lift_output_func(get_catalog_source_blueprint)
def get_catalog_source_blueprint_output(config: Optional[pulumi.Input[Optional[Mapping[str, str]]]] = None,
                                        description: Optional[pulumi.Input[Optional[str]]] = None,
                                        id: Optional[pulumi.Input[Optional[str]]] = None,
                                        name: Optional[pulumi.Input[Optional[str]]] = None,
                                        project_id: Optional[pulumi.Input[Optional[str]]] = None,
                                        opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetCatalogSourceBlueprintResult]:
    """
    This data source provides information about a catalog source of type cloud template (blueprint) in vRA.
