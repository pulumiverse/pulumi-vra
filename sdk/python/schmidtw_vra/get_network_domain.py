...
__all__ = [
    'GetNetworkDomainResult',
    'AwaitableGetNetworkDomainResult',
    'get_network_domain',
    'get_network_domain_output',
]

@pulumi.output_type
class GetNetworkDomainResult:
    """
    A collection of values returned by getNetworkDomain.
    """
    def __init__(__self__, cidr=None, cloud_account_ids=None, created_at=None, custom_properties=None, description=None, external_id=None, external_region_id=None, filter=None, id=None, links=None, name=None, organization_id=None, owner=None, tags=None, updated_at=None):
    ...
    @property
    @pulumi.getter
    def links(self) -> Sequence['outputs.GetNetworkDomainLinkResult']:
        """
    ...
    @property
    @pulumi.getter
    def tags(self) -> Sequence['outputs.GetNetworkDomainTagResult']:
        """
...
class AwaitableGetNetworkDomainResult(GetNetworkDomainResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetNetworkDomainResult(
            cidr=self.cidr,
...
def get_network_domain(filter: Optional[str] = None,
                       tags: Optional[Sequence[pulumi.InputType['GetNetworkDomainTagArgs']]] = None,
                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetNetworkDomainResult:
    """
    ## Example Usage
    ### S
    ...
    **Network Domain by filter query:**
    ...
    :param str filter: Search criteria to narrow down the network domain objects.
    :param Sequence[pulumi.InputType['GetNetworkDomainTagArgs']] tags: Set of tag keys and values to apply to the resource.
           Example:[ { "key" : "vmware", "value": "provider" } ]
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('vra:index/getNetworkDomain:getNetworkDomain', __args__, opts=opts, typ=GetNetworkDomainResult).value

    return AwaitableGetNetworkDomainResult(
        cidr=__ret__.cidr,
...
@_utilities.lift_output_func(get_network_domain)
def get_network_domain_output(filter: Optional[pulumi.Input[str]] = None,
                              tags: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetNetworkDomainTagArgs']]]]] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetNetworkDomainResult]:
    """
    ## Example Usage
    ### S
    This is an example of how to lookup Network domain objects.
