...
__all__ = ['CloudAccountGcpArgs', 'CloudAccountGcp']
...
class CloudAccountGcpArgs:
    def __init__(__self__, *,
                 ...
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input['CloudAccountGcpTagArgs']]]] = None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input['CloudAccountGcpTagArgs']]] tags: Set of tag keys and values to apply to the cloud account.  
    ...
    @property
    @pulumi.getter
    def tags(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['CloudAccountGcpTagArgs']]]]:
        """
    ...
    @tags.setter
    def tags(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['CloudAccountGcpTagArgs']]]]):
        pulumi.set(self, "tags", value)


@pulumi.input_type
class _CloudAccountGcpState:
    def __init__(__self__, *,
                 client_email: Optional[pulumi.Input[str]] = None,
                 created_at: Optional[pulumi.Input[str]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 links: Optional[pulumi.Input[Sequence[pulumi.Input['CloudAccountGcpLinkArgs']]]] = None,
                 name: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] description: Human-friendly description.
        :param pulumi.Input[Sequence[pulumi.Input['CloudAccountGcpLinkArgs']]] links: HATEOAS of entity.
        :param pulumi.Input[str] name: Name of GCP cloud account.
    ...
    @property
    @pulumi.getter
    def links(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['CloudAccountGcpLinkArgs']]]]:
        """
        HATEOAS of entity.
        """
    ...
    @links.setter
    def links(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['CloudAccountGcpLinkArgs']]]]):
...
class CloudAccountGcp(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 project_id: Optional[pulumi.Input[str]] = None,
                 regions: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CloudAccountGcpTagArgs']]]]] = None,
                 __props__=None):
        """
        ...
        this = vra.CloudAccountGcp("this",
            ...
            tags=[vra.CloudAccountGcpTagArgs(
                key="foo",
                value="bar",
            )])
        ```
        ...
        :param pulumi.Input[str] project_id: GCP Project ID.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] regions: Set of region names enabled for the cloud account.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CloudAccountGcpTagArgs']]]] tags: Set of tag keys and values to apply to the cloud account.  
               Example:[ { "key" : "vmware", "value": "provider" } ]
        """
        ...
    @overload
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param CloudAccountGcpArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CloudAccountGcpArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CloudAccountGcpArgs.__new__(CloudAccountGcpArgs)
        ...
        super(CloudAccountGcp, __self__).__init__(
            'vra:index/cloudAccountGcp:CloudAccountGcp',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            created_at: Optional[pulumi.Input[str]] = None,
            description: Optional[pulumi.Input[str]] = None,
            links: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CloudAccountGcpLinkArgs']]]]] = None,
            name: Optional[pulumi.Input[str]] = None,
            org_id: Optional[pulumi.Input[str]] = None,
            owner: Optional[pulumi.Input[str]] = None,
            private_key: Optional[pulumi.Input[str]] = None,
            ...
            regions: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CloudAccountGcpTagArgs']]]]] = None,
            updated_at: Optional[pulumi.Input[str]] = None) -> 'CloudAccountGcp':
        """
        ...
        :param pulumi.Input[str] created_at: Date when entity was created. Date and time format is ISO 8601 and UTC.
        :param pulumi.Input[str] description: Human-friendly description.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CloudAccountGcpLinkArgs']]]] links: HATEOAS of entity.
        :param pulumi.Input[str] name: Name of GCP cloud account.
        :param pulumi.Input[str] org_id: ID of organization that entity belongs to.
        :param pulumi.Input[str] owner: Email of entity owner.
        :param pulumi.Input[str] private_key: GCP Private key.
        ...
        __props__ = _CloudAccountGcpState.__new__(_CloudAccountGcpState)
        ...
        return CloudAccountGcp(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def links(self) -> pulumi.Output[Sequence['outputs.CloudAccountGcpLink']]:
        """
        HATEOAS of entity.
        """
        return pulumi.get(self, "links")
    ...
    @property
    @pulumi.getter
    def tags(self) -> pulumi.Output[Sequence['outputs.CloudAccountGcpTag']]:
        """
        Set of tag keys and values to apply to the cloud account.  
        Example:[ { "key" : "vmware", "value": "provider" } ]
        """
