...
__all__ = ['StorageProfileVsphereArgs', 'StorageProfileVsphere']

@pulumi.input_type
class StorageProfileVsphereArgs:
    def __init__(__self__, *,
                 ...
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input['StorageProfileVsphereTagArgs']]]] = None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input['StorageProfileVsphereTagArgs']]] tags: A set of tag keys and optional values that were set on this Network Profile.
    ...
    @property
    @pulumi.getter
    def tags(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['StorageProfileVsphereTagArgs']]]]:
        """
    ...
    @tags.setter
    def tags(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['StorageProfileVsphereTagArgs']]]]):
        pulumi.set(self, "tags", value)


@pulumi.input_type
class _StorageProfileVsphereState:
    def __init__(__self__, *,
                 ...
                 limit_iops: Optional[pulumi.Input[str]] = None,
                 links: Optional[pulumi.Input[Sequence[pulumi.Input['StorageProfileVsphereLinkArgs']]]] = None,
                 name: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] limit_iops: The upper bound for the I/O operations per second allocated for each virtual disk.
        :param pulumi.Input[Sequence[pulumi.Input['StorageProfileVsphereLinkArgs']]] links: HATEOAS of the entity
        :param pulumi.Input[str] name: A human-friendly name used as an identifier in APIs that support this option.
    ...
    @property
    @pulumi.getter
    def links(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['StorageProfileVsphereLinkArgs']]]]:
        """
    ...
    @links.setter
    def links(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['StorageProfileVsphereLinkArgs']]]]):
...
class StorageProfileVsphere(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 storage_policy_id: Optional[pulumi.Input[str]] = None,
                 supports_encryption: Optional[pulumi.Input[bool]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['StorageProfileVsphereTagArgs']]]]] = None,
                 __props__=None):
        """
        ## Example Usage
        ### S
        ...
        **Vra storage profile vsphere:**
        ...
        this = vra.StorageProfileVsphere("this",
            ...
            tags=[vra.StorageProfileVsphereTagArgs(
                key="foo",
                value="bar",
            )])
        ```
        ...
        :param pulumi.Input[str] storage_policy_id: Id of the vSphere Storage Policy to be applied.
        :param pulumi.Input[bool] supports_encryption: Indicates whether this storage policy should support encryption or not.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['StorageProfileVsphereTagArgs']]]] tags: A set of tag keys and optional values that were set on this Network Profile.
               example:[ { "key" : "ownedBy", "value": "Rainpole" } ]
        """
        ...
    @overload
    def __init__(__self__,
        ...
        **Vra storage profile vsphere:**
        ...
        :param str resource_name: The name of the resource.
        :param StorageProfileVsphereArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(StorageProfileVsphereArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = StorageProfileVsphereArgs.__new__(StorageProfileVsphereArgs)
        ...
        super(StorageProfileVsphere, __self__).__init__(
            'vra:index/storageProfileVsphere:StorageProfileVsphere',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            external_region_id: Optional[pulumi.Input[str]] = None,
            limit_iops: Optional[pulumi.Input[str]] = None,
            links: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['StorageProfileVsphereLinkArgs']]]]] = None,
            name: Optional[pulumi.Input[str]] = None,
            org_id: Optional[pulumi.Input[str]] = None,
            owner: Optional[pulumi.Input[str]] = None,
            provisioning_type: Optional[pulumi.Input[str]] = None,
            ...
            supports_encryption: Optional[pulumi.Input[bool]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['StorageProfileVsphereTagArgs']]]]] = None,
            updated_at: Optional[pulumi.Input[str]] = None) -> 'StorageProfileVsphere':
        """
        ...
        :param pulumi.Input[str] external_region_id: The id of the region as seen in the cloud provider for which this profile is defined.
        :param pulumi.Input[str] limit_iops: The upper bound for the I/O operations per second allocated for each virtual disk.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['StorageProfileVsphereLinkArgs']]]] links: HATEOAS of the entity
        :param pulumi.Input[str] name: A human-friendly name used as an identifier in APIs that support this option.
        :param pulumi.Input[str] org_id: The id of the organization this entity belongs to.
        :param pulumi.Input[str] owner: Email of the user that owns the entity.
        :param pulumi.Input[str] provisioning_type: Type of provisioning policy for the disk.
        ...
        __props__ = _StorageProfileVsphereState.__new__(_StorageProfileVsphereState)
        ...
        return StorageProfileVsphere(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def links(self) -> pulumi.Output[Sequence['outputs.StorageProfileVsphereLink']]:
        """
        HATEOAS of the entity
        """
        return pulumi.get(self, "links")
    ...
    @property
    @pulumi.getter
    def tags(self) -> pulumi.Output[Sequence['outputs.StorageProfileVsphereTag']]:
        """
        A set of tag keys and optional values that were set on this Network Profile.
        example:[ { "key" : "ownedBy", "value": "Rainpole" } ]
        """
