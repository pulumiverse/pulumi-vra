...
__all__ = [
    'GetRegionEnumerationAzureResult',
    'AwaitableGetRegionEnumerationAzureResult',
    'get_region_enumeration_azure',
    'get_region_enumeration_azure_output',
]

@pulumi.output_type
class GetRegionEnumerationAzureResult:
    """
...
class AwaitableGetRegionEnumerationAzureResult(GetRegionEnumerationAzureResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRegionEnumerationAzureResult(
...
def get_region_enumeration_azure(application_id: Optional[str] = None,
                                 ...
                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRegionEnumerationAzureResult:
    """
    ## Example Usage
    ### S
    ...
    **Region enumeration data source for Azure**
    ...
    __ret__ = pulumi.runtime.invoke('vra:index/getRegionEnumerationAzure:getRegionEnumerationAzure', __args__, opts=opts, typ=GetRegionEnumerationAzureResult).value

    return AwaitableGetRegionEnumerationAzureResult(
...
@_utilities.lift_output_func(get_region_enumeration_azure)
def get_region_enumeration_azure_output(application_id: Optional[pulumi.Input[str]] = None,
                                        ...
                                        opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetRegionEnumerationAzureResult]:
    """
    ## Example Usage
    ### S
