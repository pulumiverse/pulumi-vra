...
__all__ = ['StorageProfileAwsArgs', 'StorageProfileAws']

@pulumi.input_type
class StorageProfileAwsArgs:
    def __init__(__self__, *,
                 ...
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input['StorageProfileAwsTagArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['StorageProfileAwsTagArgs']]] tags: A set of tag keys and optional values that were set on this Network Profile.
    ...
    @property
    @pulumi.getter
    def tags(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['StorageProfileAwsTagArgs']]]]:
        """
    ...
    @tags.setter
    def tags(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['StorageProfileAwsTagArgs']]]]):
...
class _StorageProfileAwsState:
    def __init__(__self__, *,
                 ...
                 iops: Optional[pulumi.Input[str]] = None,
                 links: Optional[pulumi.Input[Sequence[pulumi.Input['StorageProfileAwsLinkArgs']]]] = None,
                 name: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] iops: Indicates maximum I/O operations per second in range(1-20,000).
        :param pulumi.Input[Sequence[pulumi.Input['StorageProfileAwsLinkArgs']]] links: HATEOAS of the entity
        :param pulumi.Input[str] name: A human-friendly name used as an identifier in APIs that support this option.
    ...
    @property
    @pulumi.getter
    def links(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['StorageProfileAwsLinkArgs']]]]:
        """
    ...
    @links.setter
    def links(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['StorageProfileAwsLinkArgs']]]]):
...
class StorageProfileAws(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 region_id: Optional[pulumi.Input[str]] = None,
                 supports_encryption: Optional[pulumi.Input[bool]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['StorageProfileAwsTagArgs']]]]] = None,
                 volume_type: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ## Example Usage
        ...
        **Vra storage profile aws:**
        ...
        this_storage_profile_aws = vra.StorageProfileAws("thisStorageProfileAws",
            ...
            volume_type="io1",
            iops="1000",
            tags=[vra.StorageProfileAwsTagArgs(
                key="foo",
                value="bar",
            )])
        ...
        :param pulumi.Input[str] region_id: A link to the region that is associated with the storage profile.
        :param pulumi.Input[bool] supports_encryption: Indicates whether this storage profile supports encryption or not.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['StorageProfileAwsTagArgs']]]] tags: A set of tag keys and optional values that were set on this Network Profile.
               example:[ { "key" : "ownedBy", "value": "Rainpole" } ]
        :param pulumi.Input[str] volume_type: Indicates the type of volume associated with type of storage.
        """
        ...
    ...
    def __init__(__self__,
        ...
        **Vra storage profile aws:**
        ...
        :param str resource_name: The name of the resource.
        :param StorageProfileAwsArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(StorageProfileAwsArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = StorageProfileAwsArgs.__new__(StorageProfileAwsArgs)
        ...
        super(StorageProfileAws, __self__).__init__(
            'vra:index/storageProfileAws:StorageProfileAws',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            external_region_id: Optional[pulumi.Input[str]] = None,
            iops: Optional[pulumi.Input[str]] = None,
            links: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['StorageProfileAwsLinkArgs']]]]] = None,
            name: Optional[pulumi.Input[str]] = None,
            organization_id: Optional[pulumi.Input[str]] = None,
            owner: Optional[pulumi.Input[str]] = None,
            region_id: Optional[pulumi.Input[str]] = None,
            ...
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['StorageProfileAwsTagArgs']]]]] = None,
            updated_at: Optional[pulumi.Input[str]] = None,
            volume_type: Optional[pulumi.Input[str]] = None) -> 'StorageProfileAws':
        """
        ...
        :param pulumi.Input[str] external_region_id: The id of the region as seen in the cloud provider for which this profile is defined.
        :param pulumi.Input[str] iops: Indicates maximum I/O operations per second in range(1-20,000).
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['StorageProfileAwsLinkArgs']]]] links: HATEOAS of the entity
        :param pulumi.Input[str] name: A human-friendly name used as an identifier in APIs that support this option.
        :param pulumi.Input[str] organization_id: The id of the organization this entity belongs to.
        :param pulumi.Input[str] owner: Email of the user that owns the entity.
        :param pulumi.Input[str] region_id: A link to the region that is associated with the storage profile.
        ...
        __props__ = _StorageProfileAwsState.__new__(_StorageProfileAwsState)
        ...
        __props__.__dict__["volume_type"] = volume_type
        return StorageProfileAws(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def links(self) -> pulumi.Output[Sequence['outputs.StorageProfileAwsLink']]:
        """
        HATEOAS of the entity
        """
        return pulumi.get(self, "links")
    ...
    @property
    @pulumi.getter
    def tags(self) -> pulumi.Output[Sequence['outputs.StorageProfileAwsTag']]:
        """
        A set of tag keys and optional values that were set on this Network Profile.
        example:[ { "key" : "ownedBy", "value": "Rainpole" } ]
        """
