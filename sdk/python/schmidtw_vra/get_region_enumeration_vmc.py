...
__all__ = [
    'GetRegionEnumerationVmcResult',
    'AwaitableGetRegionEnumerationVmcResult',
    'get_region_enumeration_vmc',
    'get_region_enumeration_vmc_output',
]

@pulumi.output_type
class GetRegionEnumerationVmcResult:
    """
...
class AwaitableGetRegionEnumerationVmcResult(GetRegionEnumerationVmcResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRegionEnumerationVmcResult(
...
def get_region_enumeration_vmc(accept_self_signed_cert: Optional[bool] = None,
                               ...
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRegionEnumerationVmcResult:
    """
    ## Example Usage
    ### S
    ...
    **Region enumeration data source for VMC**
    ...
    __ret__ = pulumi.runtime.invoke('vra:index/getRegionEnumerationVmc:getRegionEnumerationVmc', __args__, opts=opts, typ=GetRegionEnumerationVmcResult).value

    return AwaitableGetRegionEnumerationVmcResult(
...
@_utilities.lift_output_func(get_region_enumeration_vmc)
def get_region_enumeration_vmc_output(accept_self_signed_cert: Optional[pulumi.Input[Optional[bool]]] = None,
                                      ...
                                      opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetRegionEnumerationVmcResult]:
    """
    ## Example Usage
    ### S
