...
__all__ = ['CloudAccountNsxtArgs', 'CloudAccountNsxt']

@pulumi.input_type
class CloudAccountNsxtArgs:
    def __init__(__self__, *,
                 ...
                 manager_mode: Optional[pulumi.Input[bool]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input['CloudAccountNsxtTagArgs']]]] = None):
        """
        The set of arguments for constructing a CloudAccountNsxt resource.
        :param pulumi.Input[str] hostname: Host name for NSX-T cloud account.
        :param pulumi.Input[str] password: Password used to authenticate to the cloud Account.
        :param pulumi.Input[str] username: Username used to authenticate to the cloud account.
        ...
        :param pulumi.Input[bool] manager_mode: Create NSX-T cloud account in Manager (legacy) mode. When set to true, NSX-T cloud account is created in Manager mode.
               Mode cannot be changed after cloud account is created. Default value is false.
        :param pulumi.Input[str] name: Name of NSX-T cloud account.
        :param pulumi.Input[Sequence[pulumi.Input['CloudAccountNsxtTagArgs']]] tags: Set of tag keys and values to apply to the cloud account.  
    ...
    def manager_mode(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    @manager_mode.setter
    def manager_mode(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "manager_mode", value)
    ...
    @property
    @pulumi.getter
    def tags(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['CloudAccountNsxtTagArgs']]]]:
        """
    ...
    @tags.setter
    def tags(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['CloudAccountNsxtTagArgs']]]]):
        pulumi.set(self, "tags", value)


@pulumi.input_type
class _CloudAccountNsxtState:
    def __init__(__self__, *,
                 accept_self_signed_cert: Optional[pulumi.Input[bool]] = None,
                 ...
                 links: Optional[pulumi.Input[Sequence[pulumi.Input['CloudAccountNsxtLinkArgs']]]] = None,
                 manager_mode: Optional[pulumi.Input[bool]] = None,
                 name: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] description: Human-friendly description.
        :param pulumi.Input[str] hostname: Host name for NSX-T cloud account.
        :param pulumi.Input[Sequence[pulumi.Input['CloudAccountNsxtLinkArgs']]] links: HATEOAS of entity.
        :param pulumi.Input[bool] manager_mode: Create NSX-T cloud account in Manager (legacy) mode. When set to true, NSX-T cloud account is created in Manager mode.
               Mode cannot be changed after cloud account is created. Default value is false.
        :param pulumi.Input[str] name: Name of NSX-T cloud account.
    ...
    @property
    @pulumi.getter
    def links(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['CloudAccountNsxtLinkArgs']]]]:
        """
        HATEOAS of entity.
        """
    ...
    @links.setter
    def links(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['CloudAccountNsxtLinkArgs']]]]):
...
class CloudAccountNsxt(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 name: Optional[pulumi.Input[str]] = None,
                 password: Optional[pulumi.Input[str]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CloudAccountNsxtTagArgs']]]]] = None,
                 username: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        this = vra.CloudAccountNsxt("this",
            ...
            tags=[vra.CloudAccountNsxtTagArgs(
                key="foo",
                value="bar",
            )])
        ```
        ...
        :param pulumi.Input[str] name: Name of NSX-T cloud account.
        :param pulumi.Input[str] password: Password used to authenticate to the cloud Account.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CloudAccountNsxtTagArgs']]]] tags: Set of tag keys and values to apply to the cloud account.  
               Example:[ { "key" : "vmware", "value": "provider" } ]
        :param pulumi.Input[str] username: Username used to authenticate to the cloud account.
        """
        ...
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param CloudAccountNsxtArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CloudAccountNsxtArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CloudAccountNsxtArgs.__new__(CloudAccountNsxtArgs)
            ...
            __props__.__dict__["manager_mode"] = manager_mode
        ...
        super(CloudAccountNsxt, __self__).__init__(
            'vra:index/cloudAccountNsxt:CloudAccountNsxt',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            description: Optional[pulumi.Input[str]] = None,
            hostname: Optional[pulumi.Input[str]] = None,
            links: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CloudAccountNsxtLinkArgs']]]]] = None,
            manager_mode: Optional[pulumi.Input[bool]] = None,
            name: Optional[pulumi.Input[str]] = None,
            org_id: Optional[pulumi.Input[str]] = None,
            owner: Optional[pulumi.Input[str]] = None,
            ...
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CloudAccountNsxtTagArgs']]]]] = None,
            updated_at: Optional[pulumi.Input[str]] = None,
            username: Optional[pulumi.Input[str]] = None) -> 'CloudAccountNsxt':
        """
        ...
        :param pulumi.Input[str] description: Human-friendly description.
        :param pulumi.Input[str] hostname: Host name for NSX-T cloud account.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CloudAccountNsxtLinkArgs']]]] links: HATEOAS of entity.
        :param pulumi.Input[bool] manager_mode: Create NSX-T cloud account in Manager (legacy) mode. When set to true, NSX-T cloud account is created in Manager mode.
               Mode cannot be changed after cloud account is created. Default value is false.
        :param pulumi.Input[str] name: Name of NSX-T cloud account.
        :param pulumi.Input[str] org_id: ID of organization that entity belongs to.
        ...
        __props__ = _CloudAccountNsxtState.__new__(_CloudAccountNsxtState)
        ...
        __props__.__dict__["username"] = username
        return CloudAccountNsxt(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def links(self) -> pulumi.Output[Sequence['outputs.CloudAccountNsxtLink']]:
        """
        HATEOAS of entity.
        """
        return pulumi.get(self, "links")
    ...
    @property
    @pulumi.getter(name="managerMode")
    def manager_mode(self) -> pulumi.Output[Optional[bool]]:
        """
        Create NSX-T cloud account in Manager (legacy) mode. When set to true, NSX-T cloud account is created in Manager mode.
        Mode cannot be changed after cloud account is created. Default value is false.
        """
    ...
    @property
    @pulumi.getter
    def tags(self) -> pulumi.Output[Sequence['outputs.CloudAccountNsxtTag']]:
        """
        Set of tag keys and values to apply to the cloud account.  
        Example:[ { "key" : "vmware", "value": "provider" } ]
        """
