...
__all__ = [
    'GetRegionEnumerationResult',
    'AwaitableGetRegionEnumerationResult',
    'get_region_enumeration',
    'get_region_enumeration_output',
]

@pulumi.output_type
class GetRegionEnumerationResult:
    """
...
class AwaitableGetRegionEnumerationResult(GetRegionEnumerationResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRegionEnumerationResult(
...
def get_region_enumeration(accept_self_signed_cert: Optional[bool] = None,
                           ...
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRegionEnumerationResult:
    """
    ## Example Usage
    ### S
    ...
    **Region enumeration data source for vSphere**
    ...
    __ret__ = pulumi.runtime.invoke('vra:index/getRegionEnumeration:getRegionEnumeration', __args__, opts=opts, typ=GetRegionEnumerationResult).value

    return AwaitableGetRegionEnumerationResult(
...
@_utilities.lift_output_func(get_region_enumeration)
def get_region_enumeration_output(accept_self_signed_cert: Optional[pulumi.Input[Optional[bool]]] = None,
                                  dcid: Optional[pulumi.Input[Optional[str]]] = None,
                                  hostname: Optional[pulumi.Input[str]] = None,
                                  password: Optional[pulumi.Input[str]] = None,
                                  username: Optional[pulumi.Input[str]] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetRegionEnumerationResult]:
    """
    ## Example Usage
    ### S
