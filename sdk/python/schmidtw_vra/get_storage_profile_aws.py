...
__all__ = [
    'GetStorageProfileAwsResult',
    'AwaitableGetStorageProfileAwsResult',
    'get_storage_profile_aws',
    'get_storage_profile_aws_output',
]

@pulumi.output_type
class GetStorageProfileAwsResult:
    """
    ...
    @property
    @pulumi.getter
    def links(self) -> Sequence['outputs.GetStorageProfileAwsLinkResult']:
        """
    ...
    @property
    @pulumi.getter
    def tags(self) -> Sequence['outputs.GetStorageProfileAwsTagResult']:
...
class AwaitableGetStorageProfileAwsResult(GetStorageProfileAwsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetStorageProfileAwsResult(
...
def get_storage_profile_aws(filter: Optional[str] = None,
                            ...
                            tags: Optional[Sequence[pulumi.InputType['GetStorageProfileAwsTagArgs']]] = None,
                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetStorageProfileAwsResult:
    """
    ## Example Usage
    ### S
    ...
    **Vra storage profile data source filter by external region id:**
    ...
    :param Sequence[pulumi.InputType['GetStorageProfileAwsTagArgs']] tags: A set of tag keys and optional values that were set on this Network Profile.
    ...
    __ret__ = pulumi.runtime.invoke('vra:index/getStorageProfileAws:getStorageProfileAws', __args__, opts=opts, typ=GetStorageProfileAwsResult).value

    return AwaitableGetStorageProfileAwsResult(
...
@_utilities.lift_output_func(get_storage_profile_aws)
def get_storage_profile_aws_output(filter: Optional[pulumi.Input[Optional[str]]] = None,
                                   id: Optional[pulumi.Input[Optional[str]]] = None,
                                   tags: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetStorageProfileAwsTagArgs']]]]] = None,
                                   opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetStorageProfileAwsResult]:
    """
    ## Example Usage
    ### S
    This is an example of how to create a storage profile aws resource.
