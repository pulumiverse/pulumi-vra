 ...
 */
export function getStoragePolicyVSphere(args?: GetStoragePolicyVSphereArgs, opts?: pulumi.InvokeOptions): Promise<GetStoragePolicyVSphereResult> {
    args = args || {};
    if (!opts) {
        opts = {}
    }
    ...
    return pulumi.runtime.invoke("vra:fabric/getStoragePolicyVSphere:getStoragePolicyVSphere", {
        "filter": args.filter,
        "id": args.id,
    }, opts);
}
 ...
 */
export interface GetStoragePolicyVSphereArgs {
    /**
 ...
 */
export interface GetStoragePolicyVSphereResult {
    /**
     ...
     */
    readonly links: outputs.fabric.GetStoragePolicyVSphereLink[];
    /**
...
export function getStoragePolicyVSphereOutput(args?: GetStoragePolicyVSphereOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetStoragePolicyVSphereResult> {
    return pulumi.output(args).apply(a => getStoragePolicyVSphere(a, opts))
}

/**
 * A collection of arguments for invoking getStoragePolicyVSphere.
 */
export interface GetStoragePolicyVSphereOutputArgs {
    /**
     * Search criteria to narrow down the fabric vSphere storage policy. Only one of 'filter' or 'id' must be specified.
     */
