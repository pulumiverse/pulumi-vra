 ...
 * ```
 */
export class NetworkVSphere extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NetworkVSphereState, opts?: pulumi.CustomResourceOptions): NetworkVSphere {
        return new NetworkVSphere(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'vra:fabric/networkVSphere:NetworkVSphere';

    /**
     * Returns true if the given object is an instance of NetworkVSphere.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is NetworkVSphere {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === NetworkVSphere.__pulumiType;
    }
     ...
     */
    public /*out*/ readonly links!: pulumi.Output<outputs.fabric.NetworkVSphereLink[]>;
    /**
     * A human-friendly name used as an identifier in APIs that support this option.
     */
     ...
     */
    public readonly tags!: pulumi.Output<outputs.fabric.NetworkVSphereTag[]>;
    /**
     ...
     */
    constructor(name: string, args?: NetworkVSphereArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: NetworkVSphereArgs | NetworkVSphereState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as NetworkVSphereState | undefined;
            ...
            const args = argsOrState as NetworkVSphereArgs | undefined;
        ...
        super(NetworkVSphere.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface NetworkVSphereState {
    /**
     * Network CIDR to be used.
     */
     ...
     * HATEOAS of the entity
     */
    links?: pulumi.Input<pulumi.Input<inputs.fabric.NetworkVSphereLink>[]>;
    /**
     * A human-friendly name used as an identifier in APIs that support this option.
     */
     ...
     * Example:[ { "key" : "vmware", "value": "provider" } ]
     */
    tags?: pulumi.Input<pulumi.Input<inputs.fabric.NetworkVSphereTag>[]>;
    /**
     * Date when the entity was last updated. The date is ISO 8601 and UTC.
     */
 ...
 */
export interface NetworkVSphereArgs {
    /**
     * Network CIDR to be used.
     */
    cidr?: pulumi.Input<string>;
