 ...
 *
 * const this = vra.getStorageProfileAzure({
 ...
 * import * as vra from "@pulumi/vra";
 *
 * const thisStorageProfileAzure = pulumi.output(vra.getStorageProfileAzure({
...
export function getStorageProfileAzureOutput(args?: GetStorageProfileAzureOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetStorageProfileAzureResult> {
    return pulumi.output(args).apply(a => getStorageProfileAzure(a, opts))
}
