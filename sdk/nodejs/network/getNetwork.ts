...
export function getNetwork(args?: GetNetworkArgs, opts?: pulumi.InvokeOptions): Promise<GetNetworkResult> {
    ...
    return pulumi.runtime.invoke("vra:network/getNetwork:getNetwork", {
...
export interface GetNetworkArgs {
     ...
     */
    constraints?: inputs.network.GetNetworkConstraint[];
    /**
     ...
     */
    tags?: inputs.network.GetNetworkTag[];
}
...
export interface GetNetworkResult {
     ...
     * List of storage, network and extensibility constraints to be applied when provisioning through this project.
     */
    readonly constraints?: outputs.network.GetNetworkConstraint[];
    /**
     ...
     */
    readonly links: outputs.network.GetNetworkLink[];
     ...
     * example:[ { "key" : "ownedBy", "value": "Rainpole" } ]
     */
    readonly tags: outputs.network.GetNetworkTag[];
...
export interface GetNetworkOutputArgs {
     ...
     * List of storage, network and extensibility constraints to be applied when provisioning through this project.
     */
    constraints?: pulumi.Input<pulumi.Input<inputs.network.GetNetworkConstraintArgs>[]>;
    /**
     * The id of the image profile instance.
     */
     ...
     * example:[ { "key" : "ownedBy", "value": "Rainpole" } ]
     */
    tags?: pulumi.Input<pulumi.Input<inputs.network.GetNetworkTagArgs>[]>;
}
