...
export function getProfile(args?: GetProfileArgs, opts?: pulumi.InvokeOptions): Promise<GetProfileResult> {
    ...
    return pulumi.runtime.invoke("vra:network/getProfile:getProfile", {
        "filter": args.filter,
        "id": args.id,
...
export interface GetProfileArgs {
     ...
     */
    tags?: inputs.network.GetProfileTag[];
}
...
export interface GetProfileResult {
     ...
     */
    readonly links: outputs.network.GetProfileLink[];
    /**
     ...
     * example:[ { "key" : "ownedBy", "value": "Rainpole" } ]
     */
    readonly tags: outputs.network.GetProfileTag[];
    /**
...
export interface GetProfileOutputArgs {
     ...
     * example:[ { "key" : "ownedBy", "value": "Rainpole" } ]
     */
    tags?: pulumi.Input<pulumi.Input<inputs.network.GetProfileTagArgs>[]>;
}
