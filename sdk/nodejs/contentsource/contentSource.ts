...
export class ContentSource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'vra:contentsource/contentSource:ContentSource';
     ...
     */
    public readonly config!: pulumi.Output<outputs.contentsource.ContentSourceConfig>;
    /**
...
export interface ContentSourceState {
     ...
     * Content source custom configuration.
     */
    config?: pulumi.Input<inputs.contentsource.ContentSourceConfig>;
    /**
     * Date when the entity was created. The date is in ISO 6801 and UTC.
     */
