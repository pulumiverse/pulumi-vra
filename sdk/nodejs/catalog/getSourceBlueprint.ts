 ...
 * ```
 */
export function getSourceBlueprint(args?: GetSourceBlueprintArgs, opts?: pulumi.InvokeOptions): Promise<GetSourceBlueprintResult> {
    args = args || {};
    if (!opts) {
        opts = {}
    }
    ...
    return pulumi.runtime.invoke("vra:catalog/getSourceBlueprint:getSourceBlueprint", {
        "config": args.config,
 ...
 */
export interface GetSourceBlueprintArgs {
    /**
 ...
 */
export interface GetSourceBlueprintResult {
    /**
     * Custom configuration of the catalog source as a map of key values.
     */
...
export function getSourceBlueprintOutput(args?: GetSourceBlueprintOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetSourceBlueprintResult> {
    return pulumi.output(args).apply(a => getSourceBlueprint(a, opts))
}

/**
 * A collection of arguments for invoking getSourceBlueprint.
 */
export interface GetSourceBlueprintOutputArgs {
    /**
     * Custom configuration of the catalog source as a map of key values.
     */
