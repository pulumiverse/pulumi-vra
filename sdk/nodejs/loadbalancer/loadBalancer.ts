...
export class LoadBalancer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'vra:loadbalancer/loadBalancer:LoadBalancer';
     ...
     */
    public /*out*/ readonly links!: pulumi.Output<outputs.loadbalancer.LoadBalancerLink[]>;
    /**
     ...
     */
    public readonly nics!: pulumi.Output<outputs.loadbalancer.LoadBalancerNic[]>;
    /**
     ...
     */
    public readonly routes!: pulumi.Output<outputs.loadbalancer.LoadBalancerRoute[]>;
    /**
     * A set of tag keys and optional values that were set on this resource instance.
     * example:[ { "key" : "vmware.enumeration.type", "value": "nebsBlock" } ]
     */
    public readonly tags!: pulumi.Output<outputs.loadbalancer.LoadBalancerTag[]>;
    /**
     * A list of links to target load balancer pool members. Links can be to either a machine or a machine's network interface.
     */
    public readonly targets!: pulumi.Output<outputs.loadbalancer.LoadBalancerTarget[] | undefined>;
    /**
...
export interface LoadBalancerState {
     ...
     * HATEOAS of the entity.
     */
    links?: pulumi.Input<pulumi.Input<inputs.loadbalancer.LoadBalancerLink>[]>;
    /**
     * A human-friendly name used as an identifier in APIs that support this option.
     */
     ...
     * A set of network interface specifications for this load balancer.
     */
    nics?: pulumi.Input<pulumi.Input<inputs.loadbalancer.LoadBalancerNic>[]>;
    /**
     * The id of the organization this entity belongs to.
     */
     ...
     * The load balancer route configuration regarding ports and protocols.
     */
    routes?: pulumi.Input<pulumi.Input<inputs.loadbalancer.LoadBalancerRoute>[]>;
    /**
     * A set of tag keys and optional values that were set on this resource instance.
     * example:[ { "key" : "vmware.enumeration.type", "value": "nebsBlock" } ]
     */
    tags?: pulumi.Input<pulumi.Input<inputs.loadbalancer.LoadBalancerTag>[]>;
    /**
     * A list of links to target load balancer pool members. Links can be to either a machine or a machine's network interface.
     */
    targets?: pulumi.Input<pulumi.Input<inputs.loadbalancer.LoadBalancerTarget>[]>;
    /**
     * Date when the entity was last updated. The date is ISO 8601 and UTC.
     */
