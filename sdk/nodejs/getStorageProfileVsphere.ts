 ...
 *
 * const this = vra.getStorageProfileVsphere({
 ...
 * import * as vra from "@pulumi/vra";
 *
 * const thisStorageProfileVsphere = pulumi.output(vra.getStorageProfileVsphere({
...
export function getStorageProfileVsphereOutput(args?: GetStorageProfileVsphereOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetStorageProfileVsphereResult> {
    return pulumi.output(args).apply(a => getStorageProfileVsphere(a, opts))
}
