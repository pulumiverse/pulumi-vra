...
export function getStorageProfile(args?: GetStorageProfileArgs, opts?: pulumi.InvokeOptions): Promise<GetStorageProfileResult> {
    ...
    return pulumi.runtime.invoke("vra:storageprofile/getStorageProfile:getStorageProfile", {
...
export interface GetStorageProfileArgs {
     ...
     */
    tags?: inputs.storageprofile.GetStorageProfileTag[];
}
...
export interface GetStorageProfileResult {
     ...
     */
    readonly links: outputs.storageprofile.GetStorageProfileLink[];
    /**
     ...
     * example:[ { "key" : "ownedBy", "value": "Rainpole" } ]
     */
    readonly tags: outputs.storageprofile.GetStorageProfileTag[];
    /**
...
export interface GetStorageProfileOutputArgs {
     ...
     * example:[ { "key" : "ownedBy", "value": "Rainpole" } ]
     */
    tags?: pulumi.Input<pulumi.Input<inputs.storageprofile.GetStorageProfileTagArgs>[]>;
}
