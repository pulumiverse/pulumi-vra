...
export class StorageProfile extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'vra:storageprofile/storageProfile:StorageProfile';
     ...
     */
    public /*out*/ readonly links!: pulumi.Output<outputs.storageprofile.StorageProfileLink[]>;
    /**
     ...
     */
    public readonly tags!: pulumi.Output<outputs.storageprofile.StorageProfileTag[]>;
    /**
...
export interface StorageProfileState {
     ...
     * HATEOAS of the entity
     */
    links?: pulumi.Input<pulumi.Input<inputs.storageprofile.StorageProfileLink>[]>;
    /**
     * A human-friendly name used as an identifier in APIs that support this option.
     */
     ...
     * example:[ { "key" : "ownedBy", "value": "Rainpole" } ]
     */
    tags?: pulumi.Input<pulumi.Input<inputs.storageprofile.StorageProfileTag>[]>;
    /**
     * Date when the entity was last updated. The date is ISO 8601 and UTC.
     */
