...
export class VSphere extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'vra:storageprofile/vSphere:VSphere';
     ...
     */
    public /*out*/ readonly links!: pulumi.Output<outputs.storageprofile.VSphereLink[]>;
    /**
     ...
     */
    public readonly tags!: pulumi.Output<outputs.storageprofile.VSphereTag[]>;
    /**
...
export interface VSphereState {
     ...
     * HATEOAS of the entity
     */
    links?: pulumi.Input<pulumi.Input<inputs.storageprofile.VSphereLink>[]>;
    /**
     * A human-friendly name used as an identifier in APIs that support this option.
     */
     ...
     * example:[ { "key" : "ownedBy", "value": "Rainpole" } ]
     */
    tags?: pulumi.Input<pulumi.Input<inputs.storageprofile.VSphereTag>[]>;
    /**
     * Date when the entity was last updated. The date is ISO 8601 and UTC.
     */
