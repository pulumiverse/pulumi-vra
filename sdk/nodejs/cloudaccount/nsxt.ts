 ...
 * ```
 */
export class Nsxt extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NsxtState, opts?: pulumi.CustomResourceOptions): Nsxt {
        return new Nsxt(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'vra:cloudaccount/nsxt:Nsxt';

    /**
     * Returns true if the given object is an instance of Nsxt.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Nsxt {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Nsxt.__pulumiType;
    }
     ...
     * HATEOAS of entity.
     */
    public /*out*/ readonly links!: pulumi.Output<outputs.cloudaccount.NsxtLink[]>;
    /**
     ...
     */
    public readonly tags!: pulumi.Output<outputs.cloudaccount.NsxtTag[]>;
    /**
     ...
     */
    constructor(name: string, args: NsxtArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: NsxtArgs | NsxtState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as NsxtState | undefined;
            ...
            const args = argsOrState as NsxtArgs | undefined;
        ...
        super(Nsxt.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface NsxtState {
     ...
     * HATEOAS of entity.
     */
    links?: pulumi.Input<pulumi.Input<inputs.cloudaccount.NsxtLink>[]>;
    /**
     * Create NSX-T cloud account in Manager (legacy) mode. When set to true, NSX-T cloud account is created in Manager mode.
     * Mode cannot be changed after cloud account is created. Default value is false.
     */
     ...
     * Example:[ { "key" : "vmware", "value": "provider" } ]
     */
    tags?: pulumi.Input<pulumi.Input<inputs.cloudaccount.NsxtTag>[]>;
    /**
     * Date when entity was last updated. Date and time format is ISO 8601 and UTC.
     */
