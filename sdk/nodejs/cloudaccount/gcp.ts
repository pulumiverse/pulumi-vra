...
export class Gcp extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'vra:cloudaccount/gcp:Gcp';
     ...
     * HATEOAS of entity.
     */
    public /*out*/ readonly links!: pulumi.Output<outputs.cloudaccount.GcpLink[]>;
    /**
     ...
     */
    public readonly tags!: pulumi.Output<outputs.cloudaccount.GcpTag[]>;
    /**
...
export interface GcpState {
     ...
     * HATEOAS of entity.
     */
    links?: pulumi.Input<pulumi.Input<inputs.cloudaccount.GcpLink>[]>;
    /**
     * Name of GCP cloud account.
     */
     ...
     * Example:[ { "key" : "vmware", "value": "provider" } ]
     */
    tags?: pulumi.Input<pulumi.Input<inputs.cloudaccount.GcpTag>[]>;
    /**
     * Date when entity was last updated. Date and time format is ISO 8601 and UTC.
     */
