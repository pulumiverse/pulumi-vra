...
export class Azure extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'vra:cloudaccount/azure:Azure';
     ...
     * HATEOAS of entity.
     */
    public /*out*/ readonly links!: pulumi.Output<outputs.cloudaccount.AzureLink[]>;
    /**
     ...
     */
    public readonly tags!: pulumi.Output<outputs.cloudaccount.AzureTag[]>;
    /**
     * Azure Tenant ID.
     */
...
export interface AzureState {
     ...
     * HATEOAS of entity.
     */
    links?: pulumi.Input<pulumi.Input<inputs.cloudaccount.AzureLink>[]>;
    /**
     * Name of Azure cloud account.
     */
     ...
     * Example:[ { "key" : "vmware", "value": "provider" } ]
     */
    tags?: pulumi.Input<pulumi.Input<inputs.cloudaccount.AzureTag>[]>;
    /**
     * Azure Tenant ID.
     */
