...
export function getZone(args?: GetZoneArgs, opts?: pulumi.InvokeOptions): Promise<GetZoneResult> {
    ...
    return pulumi.runtime.invoke("vra:zone/getZone:getZone", {
        "id": args.id,
        "name": args.name,
        "tags": args.tags,
...
export interface GetZoneArgs {
     ...
     */
    tags?: inputs.zone.GetZoneTag[];
    /**
     * A set of tag keys and optional values for compute resource filtering:
     */
    tagsToMatches?: inputs.zone.GetZoneTagsToMatch[];
}
...
export interface GetZoneResult {
     ...
     */
    readonly links: outputs.zone.GetZoneLink[];
     ...
     * A set of tag keys and optional values that were set on this resource:
     */
    readonly tags: outputs.zone.GetZoneTag[];
    /**
     * A set of tag keys and optional values for compute resource filtering:
     */
    readonly tagsToMatches: outputs.zone.GetZoneTagsToMatch[];
    /**
...
export interface GetZoneOutputArgs {
     ...
     * A set of tag keys and optional values that were set on this resource:
     */
    tags?: pulumi.Input<pulumi.Input<inputs.zone.GetZoneTagArgs>[]>;
    /**
     * A set of tag keys and optional values for compute resource filtering:
     */
    tagsToMatches?: pulumi.Input<pulumi.Input<inputs.zone.GetZoneTagsToMatchArgs>[]>;
}
