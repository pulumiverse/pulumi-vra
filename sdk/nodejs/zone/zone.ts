...
export class Zone extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'vra:zone/zone:Zone';
     ...
     * HATEOAS of entity.
     */
    public /*out*/ readonly links!: pulumi.Output<outputs.zone.ZoneLink[]>;
    /**
     ...
     */
    public readonly tags!: pulumi.Output<outputs.zone.ZoneTag[]>;
    /**
     * A set of tag keys and optional values for compute resource filtering:
     */
    public readonly tagsToMatches!: pulumi.Output<outputs.zone.ZoneTagsToMatch[]>;
    /**
...
export interface ZoneState {
     ...
     * HATEOAS of entity.
     */
    links?: pulumi.Input<pulumi.Input<inputs.zone.ZoneLink>[]>;
    /**
     * A human-friendly name used as an identifier for the zone resource instance.
     */
     ...
     * A set of tag keys and optional values that were set on this resource:
     */
    tags?: pulumi.Input<pulumi.Input<inputs.zone.ZoneTag>[]>;
    /**
     * A set of tag keys and optional values for compute resource filtering:
     */
    tagsToMatches?: pulumi.Input<pulumi.Input<inputs.zone.ZoneTagsToMatch>[]>;
    /**
     * Date when the entity was last updated. The date is ISO 8601 and UTC.
     */
