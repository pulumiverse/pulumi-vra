...
namespace Pulumiverse.Vra.Project
{
    public static class GetProject
    {
        ...
        public static Task<GetProjectResult> InvokeAsync(GetProjectArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetProjectResult>("vra:project/getProject:getProject", args ?? new GetProjectArgs(), options.WithDefaults());
        ...
        public static Output<GetProjectResult> Invoke(GetProjectInvokeArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetProjectResult>("vra:project/getProject:getProject", args ?? new GetProjectInvokeArgs(), options.WithDefaults());
    }
