...
namespace pulumiverse.Vra
{
    ...
    /// </summary>
    [VraResourceType("vra:index/storageProfileVsphere:StorageProfileVsphere")]
    public partial class StorageProfileVsphere : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("links")]
        public Output<ImmutableArray<Outputs.StorageProfileVsphereLink>> Links { get; private set; } = null!;
        ...
        /// </summary>
        [Output("tags")]
        public Output<ImmutableArray<Outputs.StorageProfileVsphereTag>> Tags { get; private set; } = null!;
        ...
        public StorageProfileVsphere(string name, StorageProfileVsphereArgs args, CustomResourceOptions? options = null)
            : base("vra:index/storageProfileVsphere:StorageProfileVsphere", name, args ?? new StorageProfileVsphereArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StorageProfileVsphere(string name, Input<string> id, StorageProfileVsphereState? state = null, CustomResourceOptions? options = null)
            : base("vra:index/storageProfileVsphere:StorageProfileVsphere", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static StorageProfileVsphere Get(string name, Input<string> id, StorageProfileVsphereState? state = null, CustomResourceOptions? options = null)
        {
            return new StorageProfileVsphere(name, id, state, options);
        }
    }

    public sealed class StorageProfileVsphereArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Id of the vSphere Datastore for placing disk and VM.
        /// </summary>
        ...
        [Input("tags")]
        private InputList<Inputs.StorageProfileVsphereTagArgs>? _tags;

        /// <summary>
        /// A set of tag keys and optional values that were set on this Network Profile.
        /// example:[ { "key" : "ownedBy", "value": "Rainpole" } ]
        /// </summary>
        public InputList<Inputs.StorageProfileVsphereTagArgs> Tags
        {
            get => _tags ?? (_tags = new InputList<Inputs.StorageProfileVsphereTagArgs>());
            set => _tags = value;
        }

        public StorageProfileVsphereArgs()
        {
        }
        public static new StorageProfileVsphereArgs Empty => new StorageProfileVsphereArgs();
    }

    public sealed class StorageProfileVsphereState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Id of the cloud account this storage profile belongs to.
        /// </summary>
        ...
        [Input("links")]
        private InputList<Inputs.StorageProfileVsphereLinkGetArgs>? _links;

        /// <summary>
        /// HATEOAS of the entity
        /// </summary>
        public InputList<Inputs.StorageProfileVsphereLinkGetArgs> Links
        {
            get => _links ?? (_links = new InputList<Inputs.StorageProfileVsphereLinkGetArgs>());
            set => _links = value;
        }
        ...
        [Input("tags")]
        private InputList<Inputs.StorageProfileVsphereTagGetArgs>? _tags;

        /// <summary>
        /// A set of tag keys and optional values that were set on this Network Profile.
        /// example:[ { "key" : "ownedBy", "value": "Rainpole" } ]
        /// </summary>
        public InputList<Inputs.StorageProfileVsphereTagGetArgs> Tags
        {
            get => _tags ?? (_tags = new InputList<Inputs.StorageProfileVsphereTagGetArgs>());
            set => _tags = value;
        }
        ...
        public StorageProfileVsphereState()
        {
        }
        public static new StorageProfileVsphereState Empty => new StorageProfileVsphereState();
    }
}
