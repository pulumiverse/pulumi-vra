...
namespace schmidtw.Vra
{
    ...
    /// </summary>
    [VraResourceType("vra:index/networkProfile:NetworkProfile")]
    public partial class NetworkProfile : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("links")]
        public Output<ImmutableArray<Outputs.NetworkProfileLink>> Links { get; private set; } = null!;
        ...
        public NetworkProfile(string name, NetworkProfileArgs args, CustomResourceOptions? options = null)
            : base("vra:index/networkProfile:NetworkProfile", name, args ?? new NetworkProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkProfile(string name, Input<string> id, NetworkProfileState? state = null, CustomResourceOptions? options = null)
            : base("vra:index/networkProfile:NetworkProfile", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NetworkProfileState : global::Pulumi.ResourceArgs
    {
        ...
        [Input("links")]
        private InputList<Inputs.NetworkProfileLinkGetArgs>? _links;

        /// <summary>
        /// HATEOAS of the entity
        /// </summary>
        public InputList<Inputs.NetworkProfileLinkGetArgs> Links
        {
            get => _links ?? (_links = new InputList<Inputs.NetworkProfileLinkGetArgs>());
            set => _links = value;
        }
        ...
        [Input("tags")]
        private InputList<Inputs.NetworkProfileTagGetArgs>? _tags;

        /// <summary>
        /// A set of tag keys and optional values that were set on this Network Profile.
        /// example:[ { "key" : "ownedBy", "value": "Rainpole" } ]
        /// </summary>
        public InputList<Inputs.NetworkProfileTagGetArgs> Tags
        {
            get => _tags ?? (_tags = new InputList<Inputs.NetworkProfileTagGetArgs>());
            set => _tags = value;
        }
