...
namespace Pulumiverse.Vra.Storageprofile
{
    ...
    /// </summary>
    [VraResourceType("vra:storageprofile/azure:Azure")]
    public partial class Azure : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("links")]
        public Output<ImmutableArray<Outputs.AzureLink>> Links { get; private set; } = null!;
        ...
        /// </summary>
        [Output("tags")]
        public Output<ImmutableArray<Outputs.AzureTag>> Tags { get; private set; } = null!;
        ...
        public Azure(string name, AzureArgs args, CustomResourceOptions? options = null)
            : base("vra:storageprofile/azure:Azure", name, args ?? new AzureArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Azure(string name, Input<string> id, AzureState? state = null, CustomResourceOptions? options = null)
            : base("vra:storageprofile/azure:Azure", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AzureArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("tags")]
        private InputList<Inputs.AzureTagArgs>? _tags;

        /// <summary>
        /// A set of tag keys and optional values that were set on this Network Profile.
        /// example:[ { "key" : "ownedBy", "value": "Rainpole" } ]
        /// </summary>
        public InputList<Inputs.AzureTagArgs> Tags
        {
            get => _tags ?? (_tags = new InputList<Inputs.AzureTagArgs>());
            set => _tags = value;
        }
    ...
    public sealed class AzureState : global::Pulumi.ResourceArgs
    {
        ...
        [Input("links")]
        private InputList<Inputs.AzureLinkGetArgs>? _links;

        /// <summary>
        /// HATEOAS of the entity
        /// </summary>
        public InputList<Inputs.AzureLinkGetArgs> Links
        {
            get => _links ?? (_links = new InputList<Inputs.AzureLinkGetArgs>());
            set => _links = value;
        }
        ...
        [Input("tags")]
        private InputList<Inputs.AzureTagGetArgs>? _tags;

        /// <summary>
        /// A set of tag keys and optional values that were set on this Network Profile.
        /// example:[ { "key" : "ownedBy", "value": "Rainpole" } ]
        /// </summary>
        public InputList<Inputs.AzureTagGetArgs> Tags
        {
            get => _tags ?? (_tags = new InputList<Inputs.AzureTagGetArgs>());
            set => _tags = value;
        }
