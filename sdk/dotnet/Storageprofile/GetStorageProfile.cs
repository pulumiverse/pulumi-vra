...
namespace Pulumiverse.Vra.Storageprofile
{
    public static class GetStorageProfile
    {
        ...
        public static Task<GetStorageProfileResult> InvokeAsync(GetStorageProfileArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetStorageProfileResult>("vra:storageprofile/getStorageProfile:getStorageProfile", args ?? new GetStorageProfileArgs(), options.WithDefaults());
        ...
        public static Output<GetStorageProfileResult> Invoke(GetStorageProfileInvokeArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetStorageProfileResult>("vra:storageprofile/getStorageProfile:getStorageProfile", args ?? new GetStorageProfileInvokeArgs(), options.WithDefaults());
    }
