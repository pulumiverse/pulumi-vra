...
namespace pulumiverse.Vra
{
    public static class GetCatalogSourceBlueprint
    {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetCatalogSourceBlueprintResult> InvokeAsync(GetCatalogSourceBlueprintArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCatalogSourceBlueprintResult>("vra:index/getCatalogSourceBlueprint:getCatalogSourceBlueprint", args ?? new GetCatalogSourceBlueprintArgs(), options.WithDefaults());
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Output<GetCatalogSourceBlueprintResult> Invoke(GetCatalogSourceBlueprintInvokeArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetCatalogSourceBlueprintResult>("vra:index/getCatalogSourceBlueprint:getCatalogSourceBlueprint", args ?? new GetCatalogSourceBlueprintInvokeArgs(), options.WithDefaults());
    }


    public sealed class GetCatalogSourceBlueprintArgs : global::Pulumi.InvokeArgs
    {
        [Input("config")]
        ...
        public GetCatalogSourceBlueprintArgs()
        {
        }
        public static new GetCatalogSourceBlueprintArgs Empty => new GetCatalogSourceBlueprintArgs();
    }

    public sealed class GetCatalogSourceBlueprintInvokeArgs : global::Pulumi.InvokeArgs
    {
        [Input("config")]
        ...
        public GetCatalogSourceBlueprintInvokeArgs()
        {
        }
        public static new GetCatalogSourceBlueprintInvokeArgs Empty => new GetCatalogSourceBlueprintInvokeArgs();
    }


    [OutputType]
    public sealed class GetCatalogSourceBlueprintResult
    {
        /// <summary>
        /// Custom configuration of the catalog source as a map of key values.
        /// </summary>
        ...
        [OutputConstructor]
        private GetCatalogSourceBlueprintResult(
