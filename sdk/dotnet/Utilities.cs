...
namespace schmidtw.Vra
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "https://github.com/schmidtw/pulumi-vra/releases/download/v${VERSION}";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("schmidtw.Vra.version.txt");
    ...
    internal sealed class VraResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public VraResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
