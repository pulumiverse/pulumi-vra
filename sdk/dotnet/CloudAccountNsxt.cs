...
namespace pulumiverse.Vra
{
    ...
    /// ```
    /// </summary>
    [VraResourceType("vra:index/cloudAccountNsxt:CloudAccountNsxt")]
    public partial class CloudAccountNsxt : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("links")]
        public Output<ImmutableArray<Outputs.CloudAccountNsxtLink>> Links { get; private set; } = null!;
        ...
        /// </summary>
        [Output("tags")]
        public Output<ImmutableArray<Outputs.CloudAccountNsxtTag>> Tags { get; private set; } = null!;
        ...
        public CloudAccountNsxt(string name, CloudAccountNsxtArgs args, CustomResourceOptions? options = null)
            : base("vra:index/cloudAccountNsxt:CloudAccountNsxt", name, args ?? new CloudAccountNsxtArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CloudAccountNsxt(string name, Input<string> id, CloudAccountNsxtState? state = null, CustomResourceOptions? options = null)
            : base("vra:index/cloudAccountNsxt:CloudAccountNsxt", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static CloudAccountNsxt Get(string name, Input<string> id, CloudAccountNsxtState? state = null, CustomResourceOptions? options = null)
        {
            return new CloudAccountNsxt(name, id, state, options);
        }
    }

    public sealed class CloudAccountNsxtArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Accept self-signed certificate when connecting to the cloud account.
        /// </summary>
        ...
        [Input("tags")]
        private InputList<Inputs.CloudAccountNsxtTagArgs>? _tags;

        /// <summary>
        /// Set of tag keys and values to apply to the cloud account.  
        /// Example:[ { "key" : "vmware", "value": "provider" } ]
        /// </summary>
        public InputList<Inputs.CloudAccountNsxtTagArgs> Tags
        {
            get => _tags ?? (_tags = new InputList<Inputs.CloudAccountNsxtTagArgs>());
            set => _tags = value;
        }
        ...
        public CloudAccountNsxtArgs()
        {
        }
        public static new CloudAccountNsxtArgs Empty => new CloudAccountNsxtArgs();
    }

    public sealed class CloudAccountNsxtState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Accept self-signed certificate when connecting to the cloud account.
        /// </summary>
        ...
        [Input("links")]
        private InputList<Inputs.CloudAccountNsxtLinkGetArgs>? _links;

        /// <summary>
        /// HATEOAS of entity.
        /// </summary>
        public InputList<Inputs.CloudAccountNsxtLinkGetArgs> Links
        {
            get => _links ?? (_links = new InputList<Inputs.CloudAccountNsxtLinkGetArgs>());
            set => _links = value;
        }
        ...
        [Input("tags")]
        private InputList<Inputs.CloudAccountNsxtTagGetArgs>? _tags;

        /// <summary>
        /// Set of tag keys and values to apply to the cloud account.  
        /// Example:[ { "key" : "vmware", "value": "provider" } ]
        /// </summary>
        public InputList<Inputs.CloudAccountNsxtTagGetArgs> Tags
        {
            get => _tags ?? (_tags = new InputList<Inputs.CloudAccountNsxtTagGetArgs>());
            set => _tags = value;
        }
        ...
        public CloudAccountNsxtState()
        {
        }
        public static new CloudAccountNsxtState Empty => new CloudAccountNsxtState();
    }
}
