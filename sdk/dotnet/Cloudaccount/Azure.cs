...
namespace Pulumiverse.Vra.Cloudaccount
{
    ...
    /// ```
    /// </summary>
    [VraResourceType("vra:cloudaccount/azure:Azure")]
    public partial class Azure : global::Pulumi.CustomResource
    {
        ...
        public Azure(string name, AzureArgs args, CustomResourceOptions? options = null)
            : base("vra:cloudaccount/azure:Azure", name, args ?? new AzureArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Azure(string name, Input<string> id, AzureState? state = null, CustomResourceOptions? options = null)
            : base("vra:cloudaccount/azure:Azure", name, state, MakeResourceOptions(options, id))
        {
        }
