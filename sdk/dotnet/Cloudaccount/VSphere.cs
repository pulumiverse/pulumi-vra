...
namespace Pulumiverse.Vra.Cloudaccount
{
    ...
    /// ```
    /// </summary>
    [VraResourceType("vra:cloudaccount/vSphere:VSphere")]
    public partial class VSphere : global::Pulumi.CustomResource
    {
        ...
        public VSphere(string name, VSphereArgs args, CustomResourceOptions? options = null)
            : base("vra:cloudaccount/vSphere:VSphere", name, args ?? new VSphereArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VSphere(string name, Input<string> id, VSphereState? state = null, CustomResourceOptions? options = null)
            : base("vra:cloudaccount/vSphere:VSphere", name, state, MakeResourceOptions(options, id))
        {
        }
