...
namespace Pulumiverse.Vra.Cloudaccount
{
    ...
    /// ```
    /// </summary>
    [VraResourceType("vra:cloudaccount/vmc:Vmc")]
    public partial class Vmc : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("links")]
        public Output<ImmutableArray<Outputs.VmcLink>> Links { get; private set; } = null!;
        ...
        /// </summary>
        [Output("tags")]
        public Output<ImmutableArray<Outputs.VmcTag>> Tags { get; private set; } = null!;
        ...
        public Vmc(string name, VmcArgs args, CustomResourceOptions? options = null)
            : base("vra:cloudaccount/vmc:Vmc", name, args ?? new VmcArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Vmc(string name, Input<string> id, VmcState? state = null, CustomResourceOptions? options = null)
            : base("vra:cloudaccount/vmc:Vmc", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static Vmc Get(string name, Input<string> id, VmcState? state = null, CustomResourceOptions? options = null)
        {
            return new Vmc(name, id, state, options);
        }
    }

    public sealed class VmcArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Accept self-signed certificate when connecting to the cloud account.
        /// </summary>
        ...
        [Input("tags")]
        private InputList<Inputs.VmcTagArgs>? _tags;

        /// <summary>
        /// Set of tag keys and values to apply to the cloud account.  
        /// Example:[ { "key" : "vmware", "value": "provider" } ]
        /// </summary>
        public InputList<Inputs.VmcTagArgs> Tags
        {
            get => _tags ?? (_tags = new InputList<Inputs.VmcTagArgs>());
            set => _tags = value;
        }
        ...
        public static new VmcArgs Empty => new VmcArgs();
    }

    public sealed class VmcState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Accept self-signed certificate when connecting to the cloud account.
        /// </summary>
        ...
        [Input("links")]
        private InputList<Inputs.VmcLinkGetArgs>? _links;

        /// <summary>
        /// HATEOAS of entity.
        /// </summary>
        public InputList<Inputs.VmcLinkGetArgs> Links
        {
            get => _links ?? (_links = new InputList<Inputs.VmcLinkGetArgs>());
            set => _links = value;
        }
        ...
        [Input("tags")]
        private InputList<Inputs.VmcTagGetArgs>? _tags;

        /// <summary>
        /// Set of tag keys and values to apply to the cloud account.  
        /// Example:[ { "key" : "vmware", "value": "provider" } ]
        /// </summary>
        public InputList<Inputs.VmcTagGetArgs> Tags
        {
            get => _tags ?? (_tags = new InputList<Inputs.VmcTagGetArgs>());
            set => _tags = value;
        }
        ...
        public static new VmcState Empty => new VmcState();
    }
}
