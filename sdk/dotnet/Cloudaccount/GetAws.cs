...
namespace Pulumiverse.Vra.Cloudaccount
{
    public static class GetAws
    {
        ...
        public static Task<GetAwsResult> InvokeAsync(GetAwsArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAwsResult>("vra:cloudaccount/getAws:getAws", args ?? new GetAwsArgs(), options.WithDefaults());
        ...
        public static Output<GetAwsResult> Invoke(GetAwsInvokeArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetAwsResult>("vra:cloudaccount/getAws:getAws", args ?? new GetAwsInvokeArgs(), options.WithDefaults());
    }
