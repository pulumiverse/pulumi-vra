...
namespace Pulumiverse.Vra.Blueprint
{
    public static class GetVersion
    {
        ...
        public static Task<GetVersionResult> InvokeAsync(GetVersionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVersionResult>("vra:blueprint/getVersion:getVersion", args ?? new GetVersionArgs(), options.WithDefaults());
        ...
        public static Output<GetVersionResult> Invoke(GetVersionInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetVersionResult>("vra:blueprint/getVersion:getVersion", args ?? new GetVersionInvokeArgs(), options.WithDefaults());
    }
