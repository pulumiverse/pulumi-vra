...
namespace Pulumiverse.Vra.Deployment.Inputs
{
    ...
    public sealed class DeploymentResourceArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("expenses")]
        private InputList<Inputs.DeploymentResourceExpenseArgs>? _expenses;

        /// <summary>
        /// Expense incurred for the deployment.
        /// </summary>
        public InputList<Inputs.DeploymentResourceExpenseArgs> Expenses
        {
            get => _expenses ?? (_expenses = new InputList<Inputs.DeploymentResourceExpenseArgs>());
            set => _expenses = value;
        }
        ...
        public DeploymentResourceArgs()
        {
        }
        public static new DeploymentResourceArgs Empty => new DeploymentResourceArgs();
    }
}
