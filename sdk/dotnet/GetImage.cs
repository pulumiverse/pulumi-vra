...
namespace pulumiverse.Vra
{
    public static class GetImage
    {
        ...
        /// {
        ///     var thisCloudAccountVsphere = Vra.GetCloudAccountVsphere.Invoke(new()
        ///     {
        ///         Name = @var.Cloud_account,
        ///     });
        /// 
        ///     var thisRegion = Vra.GetRegion.Invoke(new()
        ///     {
        ///         CloudAccountId = thisCloudAccountVsphere.Apply(getCloudAccountVsphereResult =&gt; getCloudAccountVsphereResult.Id),
        ///         Region = @var.Region,
        ///     });
        /// 
        ///     var image0 = Vra.GetImage.Invoke(new()
        ///     {
        ///         Filter = $"name eq '{@var.Image_name_0}' and cloudAccountId eq '{thisCloudAccountVsphere.Apply(getCloudAccountVsphereResult =&gt; getCloudAccountVsphereResult.Id)}' and externalRegionId eq '{@var.Region}'",
        ///     });
        /// 
        ///     var image1 = Vra.GetImage.Invoke(new()
        ///     {
        ///         Filter = $"name eq '{@var.Image_name_1}' and cloudAccountId eq '{thisCloudAccountVsphere.Apply(getCloudAccountVsphereResult =&gt; getCloudAccountVsphereResult.Id)}' and externalRegionId eq '{@var.Region}'",
        ///     });
        /// 
        ///     var thisImageProfile = new Vra.ImageProfile("thisImageProfile", new()
        ///     {
        ...
        public static Task<GetImageResult> InvokeAsync(GetImageArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetImageResult>("vra:index/getImage:getImage", args ?? new GetImageArgs(), options.WithDefaults());
        ...
        public static Output<GetImageResult> Invoke(GetImageInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetImageResult>("vra:index/getImage:getImage", args ?? new GetImageInvokeArgs(), options.WithDefaults());
    }
