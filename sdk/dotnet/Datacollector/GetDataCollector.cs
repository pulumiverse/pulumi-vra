...
namespace Pulumiverse.Vra.Datacollector
{
    public static class GetDataCollector
    {
        ...
        public static Task<GetDataCollectorResult> InvokeAsync(GetDataCollectorArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDataCollectorResult>("vra:datacollector/getDataCollector:getDataCollector", args ?? new GetDataCollectorArgs(), options.WithDefaults());
        ...
        public static Output<GetDataCollectorResult> Invoke(GetDataCollectorInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDataCollectorResult>("vra:datacollector/getDataCollector:getDataCollector", args ?? new GetDataCollectorInvokeArgs(), options.WithDefaults());
    }
