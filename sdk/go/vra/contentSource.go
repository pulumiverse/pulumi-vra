...
func NewContentSource(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("vra:index/contentSource:ContentSource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContentSource(ctx *pulumi.Context,
	...
	var resource ContentSource
	err := ctx.ReadResource("vra:index/contentSource:ContentSource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
