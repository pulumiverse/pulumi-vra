...
//				Constraints: NetworkConstraintArray{
...
func NewNetwork(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("vra:index/network:Network", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetwork(ctx *pulumi.Context,
	...
	var resource Network
	err := ctx.ReadResource("vra:index/network:Network", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
