...
func NewLoadBalancer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("vra:loadbalancer/loadBalancer:LoadBalancer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLoadBalancer(ctx *pulumi.Context,
	...
	var resource LoadBalancer
	err := ctx.ReadResource("vra:loadbalancer/loadBalancer:LoadBalancer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
