...
type BlockDevice struct {
	...
	Snapshots BlockDeviceSnapshotArrayOutput `pulumi:"snapshots"`
...
func NewBlockDevice(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("vra:blockdevice/blockDevice:BlockDevice", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBlockDevice(ctx *pulumi.Context,
	...
	var resource BlockDevice
	err := ctx.ReadResource("vra:blockdevice/blockDevice:BlockDevice", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type blockDeviceState struct {
	...
	// Represents a machine snapshot.
	Snapshots []BlockDeviceSnapshot `pulumi:"snapshots"`
	// URI to use for block device. Example: ami-0d4cfd66
...
type BlockDeviceState struct {
	...
	// Represents a machine snapshot.
	Snapshots BlockDeviceSnapshotArrayInput
	// URI to use for block device. Example: ami-0d4cfd66
...
// Represents a machine snapshot.
func (o BlockDeviceOutput) Snapshots() BlockDeviceSnapshotArrayOutput {
	return o.ApplyT(func(v *BlockDevice) BlockDeviceSnapshotArrayOutput { return v.Snapshots }).(BlockDeviceSnapshotArrayOutput)
}
