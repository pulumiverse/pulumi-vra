...
// ## ---layout: "vra"
//
// page_title: "VMware vRealize Automation: BlockDevice"
// description: |-
//
...
//			_, err := vra.LookupBlockDevice(ctx, &GetBlockDeviceArgs{
...
func LookupBlockDevice(ctx *pulumi.Context, args *LookupBlockDeviceArgs, opts ...pulumi.InvokeOption) (*LookupBlockDeviceResult, error) {
	...
	err := ctx.Invoke("vra:index/getBlockDevice:getBlockDevice", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupBlockDeviceResult struct {
	...
	Snapshots []GetBlockDeviceSnapshotType `pulumi:"snapshots"`
...
func (o LookupBlockDeviceResultOutput) Snapshots() GetBlockDeviceSnapshotTypeArrayOutput {
	return o.ApplyT(func(v LookupBlockDeviceResult) []GetBlockDeviceSnapshotType { return v.Snapshots }).(GetBlockDeviceSnapshotTypeArrayOutput)
}
