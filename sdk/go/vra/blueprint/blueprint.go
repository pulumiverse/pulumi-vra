...
func NewBlueprint(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("vra:blueprint/blueprint:Blueprint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBlueprint(ctx *pulumi.Context,
	...
	var resource Blueprint
	err := ctx.ReadResource("vra:blueprint/blueprint:Blueprint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
